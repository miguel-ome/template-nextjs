    ...
    <div className="relative md:hidden">
      ...
      >
        ...
        <ul className="p-4 space-y-4 h-1/2 w-full flex flex-col justify-between items-center">
          <li><a href="#home" className="text-xl" onClick={toggleMenu}>Home</a></li>
          <li><a href="#about" className="text-xl" onClick={toggleMenu}>About</a></li>
          <li><a href="#services" className="text-xl" onClick={toggleMenu}>Services</a></li>
          <li><a href="#contact" className="text-xl" onClick={toggleMenu}>Contact</a></li>
        </ul>
      </div>
    </div>
  );
